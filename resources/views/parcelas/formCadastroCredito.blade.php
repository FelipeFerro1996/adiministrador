<div class="row">
    <div class="col-md-6">
        ...
        <select name="conta_id" class="mb-2 select2 form-control {{$errors->has('conta_id')?'is-invalid':''}}" id="conta_id">
...
<div class="row">
    ...
    <div class="col-md-4">
        <label for="">Dia vencimento crédito</label>
    ...
    <div class="col-md-4">
        <label for="">Mês primeira crédito</label>
